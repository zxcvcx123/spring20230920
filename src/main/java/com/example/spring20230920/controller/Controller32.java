...
public class Controller32 {
    ...
    @GetMapping("sub1")
    private void method1(MyDto37 dto) {
        Integer num = dao.insert1(dto);
    ...
    public void method2(MyDto38 dto) {
        ...
        System.out.println(dto); // 새 직원의 key값과 lastName 출력
    }
    ...
    public String method4(MyDto38 dto, RedirectAttributes rttr) {
        dao.insert3(dto);
        rttr.addFlashAttribute("msg", dto.getId() + "번 직원이 등록 됐습니다.");
