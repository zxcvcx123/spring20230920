...
import com.example.spring20230920.dao.MyDto20;
...
public class Controller29 {
    ...
    @GetMapping("sub8")
    public void method8() {
        LinkedHashMap<String, Object> rows = dao3.select8();
    ...
    public void method9() {
        // 1번 상품의 상품명, 가격, 카테고리명
        LinkedHashMap<String, Object> row = dao3.select9();
    ...
    public void method16() {
        ...
        List<Map<String, Object>> rows = dao3.select16();
        for (Map<String, Object> row : rows) {
            System.out.println("row = " + row);
        }
    }
    ...
    public void method20(){
        List<MyDto24> myDto24 = dao3.select20();
        System.out.println("myDto24 = " + myDto24);
    }
}
